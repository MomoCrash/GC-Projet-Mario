          ...
          <div class="card text-center" style="width: 20rem; height: 30rem; max-height: 50rem;">
            ...
            <div class="card-body">
              <form action="login.php" method="post">
                  ...
                  <button type="submit" id="connection-button" class="btn btn-primary">Connexion</button>
              </form>
              <?php
                ...
                if (isset($_POST["email"])) {
                  ...
                  try {
                    ...
                    $conn = new PDO("mysql:host=$bdd_servername;dbname=champicorp", $bdd_username, $bdd_password);
                    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                    $request =  $conn->prepare("SELECT * FROM users WHERE mail='" . $mail . "' AND  password='" . $password . "';");
                    $request->execute();
